      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          {schedules.map((schedule) => {
            ...
            return (
              <GlassCard key={schedule.id} className={`border border-zinc-800 flex flex-col justify-between ${!schedule.is_enabled ? 'opacity-60' : ''}`} hover>
                {/* Header details */}
                ...
                {/* Cron & Next Runs */}
                <div className="bg-[#09090b]/40 border border-zinc-800 p-4 rounded-xl space-y-3 mb-4 text-xs">
                ...
                {/* Controls Footer */}
                <div className="flex justify-between items-center text-xs text-slate-500 border-t border-zinc-800 pt-4">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-lg animate-in fade-in zoom-in-95 duration-200">
            <GlassCard className="border border-zinc-800 shadow-2xl overflow-y-auto max-h-[90vh]">
              ...
              <form onSubmit={handleSave} className="space-y-5">
                ...
                {/* Help text for cron */}
                <div className="text-[10px] text-slate-500 bg-[#09090b]/40 border border-zinc-800 p-3 rounded-xl flex items-start space-x-2">
